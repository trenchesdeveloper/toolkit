...
//PushJSONToRemote posts arbitrary data to a remote uri and returns the response, status code and error is any
// The client is optional, if not provided, a new client will be created
